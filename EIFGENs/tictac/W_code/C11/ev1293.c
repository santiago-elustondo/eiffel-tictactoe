...
extern EIF_TYPED_VALUE F1293_11690(EIF_REFERENCE);
extern void F1293_11691(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1293_11690 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1293_11691 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1292, Current, 0, 0, 18453);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1292, Current, 18453);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 8290, 0xF80005A1, 0); /* implementation */
