...
extern void F1309_11859(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1309_11860(EIF_REFERENCE);
extern void F1309_11861(EIF_REFERENCE);
extern void F1309_11862(EIF_REFERENCE);
extern void F1309_11863(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1309_11864(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1309_11865(EIF_REFERENCE);
...
void F1309_11859 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1308, Current, 0, 2, 18621);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1308, Current, 18621);
	RTCC(arg1, 1308, l_feature_name, 1, eif_new_type(228, 0x01), 0x01);
	{
		...
		RTCC(arg2, 1308, l_feature_name, 2, typres0, 0x01);
	}
	RTIV(Current, RTAL);
...
EIF_TYPED_VALUE F1309_11860 (EIF_REFERENCE Current)
{
	GTCX
...
#define uw1 uw1x.it_c4
	...
	RTEAA(l_feature_name, 1308, Current, 1, 0, 18622);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1308, Current, 18622);
	RTIV(Current, RTAL);
	RTHOOK(1);
	tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(8594, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	RTNHOOK(1,1);
...
void F1309_11861 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1308, Current, 0, 0, 18623);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1308, Current, 18623);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
void F1309_11862 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1308, Current, 0, 0, 18624);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1308, Current, 18624);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("not_destroyed", EX_PRE);
...
void F1309_11863 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1308, Current, 0, 0, 18625);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1308, Current, 18625);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("not_destroyed", EX_PRE);
...
EIF_TYPED_VALUE F1309_11864 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1308, Current, 0, 0, 18626);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1308, Current, 18626);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
	tb1 = '\0';
	tb2 = '\0';
	tb3 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(8295, 1301))(Current)).it_b);
	if (tb3) {
		tb3 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(8295, 1257))(Current)).it_b);
		tb2 = tb3;
	}
	if (tb2) {
		tb2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(8295, 1265))(Current)).it_b);
		tb1 = tb2;
	}
...
EIF_TYPED_VALUE F1309_11865 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1308, Current, 0, 0, 18628);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1308, Current, 18628);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 8290, 0xF80005C6, 0); /* implementation */
