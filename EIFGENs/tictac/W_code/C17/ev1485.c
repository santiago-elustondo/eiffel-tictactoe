...
extern void F1485_14573(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1485_14574(EIF_REFERENCE);
extern void F1485_14575(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1485_14576(EIF_REFERENCE);
extern void F1485_14577(EIF_REFERENCE);
...
static EIF_TYPED_VALUE F1485_14581_body(EIF_REFERENCE);
...
void F1485_14573 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1484, Current, 0, 1, 20847);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1484, Current, 20847);
	RTCC(arg1, 1484, l_feature_name, 1, RTWCT(9225, dtype, Dftype(Current)), 0x01);
	RTIV(Current, RTAL);
...
#define up1 up1x.it_p
	...
	up1 = tp1;
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(9743, Dtype(Current)))(Current, up1x);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(2);
	RTDBGLE;
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 1484, Current, 0, 0, 20849);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1484, Current, 20849);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F1485_14576 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1484, Current, 0, 0, 20850);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1484, Current, 20850);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F1485_14577 (EIF_REFERENCE Current)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 1484, Current, 0, 0, 20851);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1484, Current, 20851);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
body:;
	...
	if ((EIF_BOOLEAN) !tb1) {
		RTHOOK(3);
		RTDBGAA(Current, dtype, 10789, 0x04000000, 1); /* ignore_select_actions */
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 1484, Current, 0, 0, 20852);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1484, Current, 20852);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("is_selectable", EX_PRE);
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1484, Current, 0, 0, 20853);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1484, Current, 20853);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
	tb1 = '\0';
	...
	if ((EIF_BOOLEAN)(tr1 != NULL)) {
		tb2 = *(EIF_BOOLEAN *)(Current + RTWA(10789, dtype));
		tb1 = (EIF_BOOLEAN) !tb2;
	}
	Result = (EIF_BOOLEAN) tb1;
	RTVI(Current, RTAL);
...
static EIF_TYPED_VALUE F1485_14581_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1484, Current, 0, 0, 20855);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1484, Current, 20855);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1485_14581 (EIF_REFERENCE Current)
{
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9225, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1485_14581_body (Current)).it_r;
