...
extern EIF_TYPED_VALUE F1506_15033(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1506_15034(EIF_REFERENCE);
extern void F1506_15035(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1506_15036(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1506_15037(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1506_15038(EIF_REFERENCE);
extern void F1506_15039(EIF_REFERENCE);
static EIF_TYPED_VALUE F1506_15040_body(EIF_REFERENCE);
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1505, Current, 0, 1, 21226);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1505, Current, 21226);
	RTCC(arg1, 1505, l_feature_name, 1, RTWCT(9225, dtype, Dftype(Current)), 0x01);
	RTIV(Current, RTAL);
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 1505, Current, 0, 0, 21227);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1505, Current, 21227);
	RTIV(Current, RTAL);
	RTHOOK(1);
	ub1 = (EIF_BOOLEAN) 1;
...
EIF_TYPED_VALUE F1506_15033 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1505, Current, 2, 0, 21228);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1505, Current, 21228);
	RTIV(Current, RTAL);
	RTHOOK(1);
	tb1 = '\0';
	...
	if (tb1) {
		...
		ur1 = RTCCL(loc2);
		tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(10244, "item_pixmap", loc1))(loc1, ur1x)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
...
EIF_TYPED_VALUE F1506_15034 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1505, Current, 2, 0, 21229);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1505, Current, 21229);
	RTIV(Current, RTAL);
	RTHOOK(1);
	tb1 = '\0';
	tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(10999, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	...
	if (tb1) {
		...
		ur1 = RTCCL(loc2);
		tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(10225, "item_text", loc1))(loc1, ur1x)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
		Result = (EIF_REFERENCE) RTCCL(tr1);
	} else {
		RTHOOK(3);
		RTDBGAL(Current, 0, 0xF80000ED, 0,0); /* Result */
...
#define uu4_1 uu4_1x.it_n4
	...
	RTEAA(l_feature_name, 1505, Current, 3, 1, 21220);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1505, Current, 21220);
...
body:;
	...
	if (tb1) {
		...
		ur1 = RTCCL(loc2);
		ur2 = RTCCL(arg1);
		(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTVF(10234, "set_item_text", loc1))(loc1, ur1x, ur2x);
	}
	if (RTAL & CK_ENSURE) {
		RTHOOK(5);
...
#define ur2 ur2x.it_r
	...
	RTEAA(l_feature_name, 1505, Current, 2, 1, 21221);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1505, Current, 21221);
	RTCC(arg1, 1505, l_feature_name, 1, eif_new_type(1293, 0x01), 0x01);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
body:;
	...
	if (tb1) {
		...
		ur1 = RTCCL(loc2);
		ur2 = RTCCL(arg1);
		(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTVF(10247, "set_item_pixmap", loc1))(loc1, ur1x, ur2x);
	}
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(4);
...
void F1506_15037 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur2 ur2x.it_r
	...
	RTEAA(l_feature_name, 1505, Current, 2, 0, 21222);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1505, Current, 21222);
	RTIV(Current, RTAL);
	RTHOOK(1);
	tb1 = '\0';
	tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(10999, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
...
EIF_TYPED_VALUE F1506_15038 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1505, Current, 1, 0, 21223);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1505, Current, 21223);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	if (EIF_TEST(loc1)) {
		...
		Result = RTCCL(tr1);
		Result = RTRV(eif_new_type(1410, 0x00), Result);
	}
	if (RTAL & CK_ENSURE) {
		RTHOOK(3);
...
void F1506_15039 (EIF_REFERENCE Current)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 1505, Current, 0, 0, 21224);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1505, Current, 21224);
	RTIV(Current, RTAL);
	RTHOOK(1);
	ub1 = (EIF_BOOLEAN) 1;
...
static EIF_TYPED_VALUE F1506_15040_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1505, Current, 0, 0, 21225);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1505, Current, 21225);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1506_15040 (EIF_REFERENCE Current)
{
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9225, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1506_15040_body (Current)).it_r;
