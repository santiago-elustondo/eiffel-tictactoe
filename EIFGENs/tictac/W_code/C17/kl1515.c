...
extern EIF_TYPED_VALUE F1515_15147(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1515_15147 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur2 ur2x.it_r
	...
	RTEAA(l_feature_name, 1514, Current, 0, 0, 21337);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1514, Current, 21337);
	RTIV(Current, RTAL);
	RTHOOK(1);
