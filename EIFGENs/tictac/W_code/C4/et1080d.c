...
static const EIF_TYPE_INDEX egt_13_1080 [] = {0xFF01,247,0xFF01,231,0xFFFF};
static const EIF_TYPE_INDEX egt_14_1080 [] = {0xFF01,231,0xFFFF};
static const EIF_TYPE_INDEX egt_15_1080 [] = {0xFF01,231,0xFFFF};
...
static const struct desc_info desc_1080[] = {
	...
	{EIF_GENERIC(egt_9_1080), 15487, 0xFFFFFFFF},
	...
	{EIF_GENERIC(egt_13_1080), 15484, 0},
	{EIF_GENERIC(egt_14_1080), 15485, 0xFFFFFFFF},
	{EIF_GENERIC(egt_15_1080), 15486, 0xFFFFFFFF},
};
void Init1080(void)
{
	IDSC(desc_1080, 0, 1079);
	IDSC(desc_1080 + 1, 1, 1079);
	IDSC(desc_1080 + 32, 407, 1079);
	IDSC(desc_1080 + 34, 409, 1079);
}
