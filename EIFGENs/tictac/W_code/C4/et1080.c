...
extern void F1080_9252(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1080_9253(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1080_9254(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1080_9255(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1080_9256(EIF_REFERENCE);
...
/* {ETF_ENUM_PARAM}.make */
void F1080_9252 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_r
	...
	RTEAA(l_feature_name, 1079, Current, 0, 1, 15483);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1079, Current, 15483);
	{
	...
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, Dtype(Current), 7029, 0xF80000F7, 0); /* items */
	RTAR(Current, arg1);
	*(EIF_REFERENCE *)(Current + RTWA(7029, Dtype(Current))) = (EIF_REFERENCE) RTCCL(arg1);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(2);
	RTDBGLE;
...
EIF_TYPED_VALUE F1080_9253 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
EIF_TYPED_VALUE F1080_9254 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1079, Current, 0, 0, 15485);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1079, Current, 15485);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F1080_9255 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1079, Current, 1, 0, 15486);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1079, Current, 15486);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF80000E7, 0,0); /* Result */
	...
	for (;;) {
		...
		RTHOOK(5);
		tr1 = RTMS_EX_H("\"",1,34);
		tr2 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(7029, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
		ui4_1 = loc1;
...
/* {ETF_ENUM_PARAM}.out */
EIF_TYPED_VALUE F1080_9256 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1079, Current, 1, 0, 15487);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1079, Current, 15487);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF80000E7, 0,0); /* Result */
	tr1 = RTLN(eif_new_type(231, 0x01).id);
