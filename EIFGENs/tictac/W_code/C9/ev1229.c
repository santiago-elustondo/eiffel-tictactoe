...
extern EIF_TYPED_VALUE F1229_10750(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1229_10750 (EIF_REFERENCE Current)
{
	GTCX
...
#define up2 up2x.it_p
	...
	RTEAA(l_feature_name, 1228, Current, 0, 0, 17502);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1228, Current, 17502);
	RTIV(Current, RTAL);
	RTHOOK(1);
