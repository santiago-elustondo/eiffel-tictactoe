...
static const EIF_TYPE_INDEX egt_14_970 [] = {0xFF01,1157,0xFFFF};
static const EIF_TYPE_INDEX egt_15_970 [] = {0xFF01,1156,0xFFFF};
...
static const struct desc_info desc_970[] = {
	...
	{EIF_GENERIC(egt_13_970), 14526, 0xFFFFFFFF},
	{EIF_GENERIC(egt_14_970), 14527, 0xFFFFFFFF},
	{EIF_GENERIC(egt_15_970), 14528, 0xFFFFFFFF},
};
void Init970(void)
{
	IDSC(desc_970, 0, 969);
	IDSC(desc_970 + 1, 1, 969);
	IDSC(desc_970 + 32, 555, 969);
}
