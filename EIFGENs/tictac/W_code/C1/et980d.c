...
static const EIF_TYPE_INDEX egt_1_980 [] = {0xFF01,1559,979,0xFFFF};
...
static const EIF_TYPE_INDEX egt_14_980 [] = {0xFF01,977,0xFFFF};
...
static const struct desc_info desc_980[] = {
	...
	{EIF_GENERIC(egt_14_980), 14701, 0xFFFFFFFF},
};
void Init980(void)
{
	IDSC(desc_980, 0, 979);
	IDSC(desc_980 + 1, 1, 979);
	IDSC(desc_980 + 32, 372, 979);
}
