...
static const EIF_TYPE_INDEX egt_14_960 [] = {0xFF01,160,0xFFFF};
...
static const struct desc_info desc_960[] = {
	...
	{EIF_NON_GENERIC(0x0195 /*202*/), 13366, 0xFFFFFFFF},
	{EIF_NON_GENERIC(0x0195 /*202*/), 13367, 0xFFFFFFFF},
	{EIF_GENERIC(egt_13_960), 13368, 0xFFFFFFFF},
	{EIF_NON_GENERIC(0x01CF /*231*/), 13369, 0xFFFFFFFF},
	{EIF_GENERIC(egt_14_960), 13370, 0xFFFFFFFF},
};
void Init960(void)
{
	IDSC(desc_960, 0, 959);
	IDSC(desc_960 + 1, 1, 959);
	IDSC(desc_960 + 32, 851, 959);
}
