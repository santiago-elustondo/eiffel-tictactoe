...
static const EIF_TYPE_INDEX egt_13_1013 [] = {0xFF01,1146,0xFFFF};
static const EIF_TYPE_INDEX egt_14_1013 [] = {0xFF01,1146,0xFFFF};
static const EIF_TYPE_INDEX egt_15_1013 [] = {0xFF01,1146,0xFFFF};
...
static const struct desc_info desc_1013[] = {
	...
	{EIF_GENERIC(egt_13_1013), 14890, 0xFFFFFFFF},
	{EIF_NON_GENERIC(0x08F5 /*1146*/), 14891, 0},
	{EIF_GENERIC(egt_14_1013), 14892, 0xFFFFFFFF},
	{EIF_NON_GENERIC(0x08F5 /*1146*/), 14893, 8},
	{EIF_GENERIC(egt_15_1013), 14894, 0xFFFFFFFF},
	{EIF_NON_GENERIC(0x08F5 /*1146*/), 14895, 16},
};
void Init1013(void)
{
	IDSC(desc_1013, 0, 1012);
	IDSC(desc_1013 + 1, 1, 1012);
	IDSC(desc_1013 + 32, 727, 1012);
}
