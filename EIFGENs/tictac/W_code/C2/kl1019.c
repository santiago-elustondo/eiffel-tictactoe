...
extern EIF_TYPED_VALUE F1019_8628(EIF_REFERENCE);
...
RTOID (F1019_8628)
EIF_TYPED_VALUE F1019_8628 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1018, Current, 0, 0, 14917);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1018, Current, 14917);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
