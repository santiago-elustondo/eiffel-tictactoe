...
extern EIF_TYPED_VALUE F991_8438(EIF_REFERENCE);
...
RTOID (F991_8438)
EIF_TYPED_VALUE F991_8438 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 990, Current, 0, 0, 14751);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(990, Current, 14751);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
