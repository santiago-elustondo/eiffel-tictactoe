...
extern EIF_TYPED_VALUE F999_8474(EIF_REFERENCE);
static EIF_TYPED_VALUE F999_8475_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F999_8475(EIF_REFERENCE);
...
EIF_TYPED_VALUE F999_8474 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 998, Current, 1, 0, 14787);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(998, Current, 14787);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	if (EIF_TEST(loc1)) {
		...
		RTHOOK(4);
		RTDBGAA(Current, dtype, 6308, 0xF800046F, 0); /* item_select_actions_internal */
		RTAR(Current, Result);
		*(EIF_REFERENCE *)(Current + RTWA(6308, dtype)) = (EIF_REFERENCE) RTCCL(Result);
	}
	if (RTAL & CK_ENSURE) {
		RTHOOK(5);
...
static EIF_TYPED_VALUE F999_8475_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 998, Current, 0, 0, 14788);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(998, Current, 14788);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F999_8475 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(6308, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F999_8475_body (Current)).it_r;
