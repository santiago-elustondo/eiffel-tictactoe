...
extern EIF_TYPED_VALUE F1004_8556(EIF_REFERENCE);
...
RTOID (F1004_8556)
EIF_TYPED_VALUE F1004_8556 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1003, Current, 0, 0, 14853);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1003, Current, 14853);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
