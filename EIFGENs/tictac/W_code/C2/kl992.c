...
extern EIF_TYPED_VALUE F992_8439(EIF_REFERENCE);
extern EIF_TYPED_VALUE F992_8440(EIF_REFERENCE);
...
RTOID (F992_8439)
EIF_TYPED_VALUE F992_8439 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 991, Current, 0, 0, 14752);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(991, Current, 14752);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
...
RTOID (F992_8440)
EIF_TYPED_VALUE F992_8440 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 991, Current, 0, 0, 14753);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(991, Current, 14753);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
...
{
	GTCX
	RTOTS (8439,F992_8439)
	RTOTS (8440,F992_8440)
}
