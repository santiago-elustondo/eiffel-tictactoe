...
extern EIF_TYPED_VALUE F1045_8947(EIF_REFERENCE);
...
RTOID (F1045_8947)
EIF_TYPED_VALUE F1045_8947 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1044, Current, 0, 0, 15216);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1044, Current, 15216);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
