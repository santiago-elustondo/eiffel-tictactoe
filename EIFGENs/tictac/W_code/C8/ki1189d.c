...
static const EIF_TYPE_INDEX egt_18_1189 [] = {0xFF01,1127,0xFFFF};
...
void Init1189(void)
{
	...
	IDSC(desc_1189 + 32, 775, 1188);
	IDSC(desc_1189 + 43, 668, 1188);
	IDSC(desc_1189 + 56, 550, 1188);
	IDSC(desc_1189 + 57, 549, 1188);
	IDSC(desc_1189 + 60, 553, 1188);
	IDSC(desc_1189 + 61, 544, 1188);
