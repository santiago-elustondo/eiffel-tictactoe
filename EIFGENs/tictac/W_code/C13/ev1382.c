...
extern EIF_TYPED_VALUE F1382_13051(EIF_REFERENCE);
extern void F1382_13052(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1382_13055(EIF_REFERENCE);
static EIF_TYPED_VALUE F1382_13056_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1382_13056(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1382_13051 (EIF_REFERENCE Current)
{
	GTCX
...
#define up2 up2x.it_p
	...
	RTEAA(l_feature_name, 1381, Current, 3, 0, 19606);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	up1 = tp1;
	loc1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(5417, 967))(Current, up1x)).it_p);
	RTHOOK(3);
	if ((EIF_BOOLEAN)(loc1 != loc2)) {
		RTHOOK(4);
		up1 = loc1;
		tp1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(5559, 967))(Current, up1x)).it_p);
		up1 = tp1;
...
void F1382_13052 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1381, Current, 3, 1, 19607);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1381, Current, 19607);
	RTCC(arg1, 1381, l_feature_name, 1, eif_new_type(228, 0x01), 0x01);
	RTIV(Current, RTAL);
...
body:;
	...
	RTHOOK(3);
	tp1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(9996, dtype))(Current)).it_p);
	up1 = tp1;
	tp2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(9994, dtype))(Current)).it_p);
	up2 = tp2;
	tp3 = *(EIF_POINTER *)(loc1 + RTVA(8043, "item", loc1));
	up3 = tp3;
	up4 = loc3;
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTWF(5421, 967))(Current, up1x, up2x, up3x, up4x);
	RTHOOK(4);
...
EIF_TYPED_VALUE F1382_13055 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(9995, Dtype(Current)))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	RTNHOOK(1,1);
...
static EIF_TYPED_VALUE F1382_13056_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1381, Current, 0, 0, 19609);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
...
EIF_TYPED_VALUE F1382_13056 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9225, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1382_13056_body (Current)).it_r;
