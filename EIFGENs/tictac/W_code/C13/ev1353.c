...
static EIF_TYPED_VALUE F1353_12498_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1353_12498(EIF_REFERENCE);
extern void F1353_16314(EIF_REFERENCE, int);
...
static EIF_TYPED_VALUE F1353_12498_body (EIF_REFERENCE Current)
{
	GTCX
...
EIF_TYPED_VALUE F1353_12498 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9225, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1353_12498_body (Current)).it_r;
...
void F1353_16314 (EIF_REFERENCE Current, int where)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 1352, Current, 0, 16313);
	RTSA(dtype);
	RTME(dtype, 0);
	RTIT("not_has_text_implies_text_empty", Current);
	tb1 = '\01';
	tb2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(9524, dtype))(Current)).it_b);
	if ((EIF_BOOLEAN) !tb2) {
