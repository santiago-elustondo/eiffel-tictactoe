...
static EIF_TYPED_VALUE F1367_12970_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1367_12970(EIF_REFERENCE);
extern void F1367_16320(EIF_REFERENCE, int);
...
static EIF_TYPED_VALUE F1367_12970_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1366, Current, 0, 0, 19552);
	RTSA(Dtype(Current));
	RTSC;
...
EIF_TYPED_VALUE F1367_12970 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9225, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1367_12970_body (Current)).it_r;
...
void F1367_16320 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 1366, Current, 0, 16319);
	RTSA(dtype);
	RTME(dtype, 0);
