...
extern void F1096_9312(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1096_9313(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1096_9314(EIF_REFERENCE);
...
/* {ETF_STR_ARG}.make */
void F1096_9312 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_r
	...
	RTEAA(l_feature_name, 1095, Current, 0, 1, 15543);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1095, Current, 15543);
	RTCC(arg1, 1095, l_feature_name, 1, eif_new_type(231, 0x01), 0x01);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	*(EIF_REFERENCE *)(Current + RTWA(7050, dtype)) = (EIF_REFERENCE) RTCCL(tr1);
	RTHOOK(2);
	RTDBGAA(Current, dtype, 7075, 0xF80000E7, 0); /* value */
	RTAR(Current, arg1);
...
/* {ETF_STR_ARG}.value */
EIF_TYPED_VALUE F1096_9313 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
/* {ETF_STR_ARG}.out */
EIF_TYPED_VALUE F1096_9314 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1095, Current, 0, 0, 15545);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1095, Current, 15545);
	RTIV(Current, RTAL);
	RTHOOK(1);
