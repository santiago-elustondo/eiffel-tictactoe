...
extern EIF_TYPED_VALUE F1328_12023(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1328_12024(EIF_REFERENCE);
extern void F1328_12025(EIF_REFERENCE);
extern void F1328_12026(EIF_REFERENCE);
...
/* {EV_MENU_BAR}.parent */
EIF_TYPED_VALUE F1328_12023 (EIF_REFERENCE Current)
{
	GTCX
...
#define up2 up2x.it_p
	...
	RTEAA(l_feature_name, 1327, Current, 0, 0, 18789);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1327, Current, 18789);
	RTIV(Current, RTAL);
...
body:;
	...
	RTNHOOK(2,1);
	tr2 = ((up2x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(9945, "parent", tr1))(tr1)), (((up2x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up2x.it_r = RTBU(up2x))), (up2x.type = SK_POINTER), up2x.it_r);
...
EIF_TYPED_VALUE F1328_12024 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1328_12025 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1327, Current, 0, 0, 18791);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1327, Current, 18791);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
void F1328_12026 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1327, Current, 0, 0, 18792);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1327, Current, 18792);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 8290, 0xF8000557, 0); /* implementation */
