...
extern void F1423_13515(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1423_13516(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1423_13517(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1423_13518(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1423_13519(EIF_REFERENCE);
extern void F1423_13520(EIF_REFERENCE, EIF_TYPED_VALUE);
static EIF_TYPED_VALUE F1423_13521_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1423_13521(EIF_REFERENCE);
...
void F1423_13515 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTCC(arg1, 1422, l_feature_name, 1, RTWCT(9225, dtype, Dftype(Current)), 0x01);
	RTIV(Current, RTAL);
...
/* {EV_CELL_IMP}.make */
void F1423_13516 (EIF_REFERENCE Current)
{
	GTCX
...
/* {EV_CELL_IMP}.has */
EIF_TYPED_VALUE F1423_13517 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1422, Current, 0, 1, 19959);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1422, Current, 19959);
	RTCC(arg1, 1422, l_feature_name, 1, RTWCT(10290, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {EV_CELL_IMP}.item */
EIF_TYPED_VALUE F1423_13518 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
/* {EV_CELL_IMP}.count */
EIF_TYPED_VALUE F1423_13519 (EIF_REFERENCE Current)
{
	GTCX
...
/* {EV_CELL_IMP}.replace */
void F1423_13520 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1422, Current, 0, 1, 19962);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	RTHOOK(1);
	ur1 = RTCCL(arg1);
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(10190, 1405))(Current, ur1x);
	RTHOOK(2);
	RTDBGAA(Current, dtype, 10290, 0xF80004F2, 0); /* item */
	RTAR(Current, arg1);
	*(EIF_REFERENCE *)(Current + RTWA(10290, dtype)) = (EIF_REFERENCE) RTCCL(arg1);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(3);
	RTDBGLE;
...
static EIF_TYPED_VALUE F1423_13521_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1422, Current, 0, 0, 19963);
	RTSA(Dtype(Current));
	RTSC;
...
EIF_TYPED_VALUE F1423_13521 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9225, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1423_13521_body (Current)).it_r;
