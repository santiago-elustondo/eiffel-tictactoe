...
extern void F1436_13773(EIF_REFERENCE);
static EIF_TYPED_VALUE F1436_13777_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1436_13777(EIF_REFERENCE);
...
/* {EV_TREE_I}.make */
void F1436_13773 (EIF_REFERENCE Current)
{
	GTCX
...
/* {EV_TREE_I}.interface */
static EIF_TYPED_VALUE F1436_13777_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1435, Current, 0, 0, 20181);
	RTSA(Dtype(Current));
	RTSC;
...
EIF_TYPED_VALUE F1436_13777 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9225, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1436_13777_body (Current)).it_r;
