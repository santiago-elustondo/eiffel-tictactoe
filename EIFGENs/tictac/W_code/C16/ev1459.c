...
extern void F1459_14142(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1459_14143(EIF_REFERENCE);
static EIF_TYPED_VALUE F1459_14144_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1459_14144(EIF_REFERENCE);
...
void F1459_14142 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTCC(arg1, 1458, l_feature_name, 1, RTWCT(9225, dtype, Dftype(Current)), 0x01);
	RTIV(Current, RTAL);
...
void F1459_14143 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui1_1 ui1_1x.it_i1
	...
	loc1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(5346, 967))(Current)).it_p);
	RTHOOK(3);
	up1 = loc1;
	...
	RTHOOK(6);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWF(9220, 1457))(Current);
	if (RTAL & CK_ENSURE) {
		RTHOOK(7);
...
static EIF_TYPED_VALUE F1459_14144_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1458, Current, 0, 0, 20430);
	RTSA(Dtype(Current));
	RTSC;
...
EIF_TYPED_VALUE F1459_14144 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9225, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1459_14144_body (Current)).it_r;
