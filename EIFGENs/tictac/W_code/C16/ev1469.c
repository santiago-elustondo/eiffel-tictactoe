...
static EIF_TYPED_VALUE F1469_14421_body(EIF_REFERENCE);
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1468, Current, 1, 0, 20700);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1468, Current, 20700);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	if (EIF_TEST(loc1)) {
		...
		{
			static EIF_TYPE_INDEX typarr0[] = {1578,0xFF01,1301,0xFFFF};
			EIF_TYPE typres0;
...
/* {EV_ITEM_I}.interface */
static EIF_TYPED_VALUE F1469_14421_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1468, Current, 0, 0, 20701);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1468, Current, 20701);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1469_14421 (EIF_REFERENCE Current)
{
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9225, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1469_14421_body (Current)).it_r;
