...
extern void F1457_14132(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1457_14133(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1457_14134(EIF_REFERENCE);
extern void F1457_14135(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1457_14136(EIF_REFERENCE);
extern void F1457_14137(EIF_REFERENCE);
extern void F1457_14138(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1457_14139(EIF_REFERENCE);
static EIF_TYPED_VALUE F1457_14140_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1457_14140(EIF_REFERENCE);
...
void F1457_14132 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1456, Current, 0, 1, 20423);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1456, Current, 20423);
	RTCC(arg1, 1456, l_feature_name, 1, RTWCT(9225, dtype, Dftype(Current)), 0x01);
	RTIV(Current, RTAL);
...
/* {EV_LABEL_IMP}.make */
void F1457_14133 (EIF_REFERENCE Current)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 1456, Current, 2, 0, 20424);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTAOMS(14132,1);
	RTDBGEAA(1456, Current, 20424);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	RTNHOOK(4,1);
	RTCOMS(tr2,14132,0,"justify",7,1848530809);
	ur1 = tr2;
...
/* {EV_LABEL_IMP}.angle */
EIF_TYPED_VALUE F1457_14134 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REAL32;
	r.it_r4 = *(EIF_REAL_32 *)(Current + RTWA(10653,Dtype(Current)));
	return r;
}


/* {EV_LABEL_IMP}.set_angle */
void F1457_14135 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur4_1 ur4_1x.it_r4
	...
	RTEAA(l_feature_name, 1456, Current, 0, 1, 20426);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1456, Current, 20426);
	RTIV(Current, RTAL);
	RTHOOK(1);
	tp1 = *(EIF_POINTER *)(Current + RTWA(10020, dtype));
	up1 = tp1;
	ur4_1 = (EIF_REAL_32) ((EIF_REAL_32) ((EIF_REAL_64) (arg1) /  (EIF_REAL_64) ((EIF_REAL_32) 3.14)) * (EIF_REAL_32) 180.0);
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTWF(5630, 968))(Current, up1x, ur4_1x);
	RTHOOK(2);
	RTDBGAA(Current, dtype, 10653, 0x18000000, 1); /* angle */
	*(EIF_REAL_32 *)(Current + RTWA(10653, dtype)) = (EIF_REAL_32) arg1;
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(3);
	RTDBGLE;
...
void F1457_14136 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1456, Current, 0, 0, 20418);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1456, Current, 20418);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
void F1457_14137 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1456, Current, 0, 0, 20419);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1456, Current, 20419);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
void F1457_14138 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1456, Current, 0, 0, 20420);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1456, Current, 20420);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1457_14139 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
...
static EIF_TYPED_VALUE F1457_14140_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1456, Current, 0, 0, 20422);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1456, Current, 20422);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1457_14140 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9225, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1457_14140_body (Current)).it_r;
