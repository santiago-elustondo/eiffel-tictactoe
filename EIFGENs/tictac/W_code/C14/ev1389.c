...
extern EIF_TYPED_VALUE F1389_13101(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1389_13101 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1388, Current, 0, 0, 19642);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1388, Current, 19642);
	RTIV(Current, RTAL);
	RTHOOK(1);
