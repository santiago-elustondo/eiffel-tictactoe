...
extern void F1409_13398(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern void F1409_13399(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern void F1409_13400(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern void F1409_13401(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern void F1409_13403(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern void F1409_13404(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
static EIF_TYPED_VALUE F1409_13406_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1409_13406(EIF_REFERENCE);
...
void F1409_13398 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x, EIF_TYPED_VALUE arg3x, EIF_TYPED_VALUE arg4x, EIF_TYPED_VALUE arg5x)
{
	GTCX
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 1408, Current, 0, 5, 19872);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1408, Current, 19872);
	RTCC(arg1, 1408, l_feature_name, 1, eif_new_type(1266, 0x01), 0x01);
	RTIV(Current, RTAL);
...
body:;
	...
	ui4_1 = arg2;
	ui4_2 = arg3;
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTWF(10239, dtype))(Current, ur1x, ui4_1x, ui4_2x);
	RTHOOK(7);
	ur1 = RTCCL(arg1);
	ui4_1 = arg4;
	ui4_2 = arg5;
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTWF(10242, dtype))(Current, ur1x, ui4_1x, ui4_2x);
	if (RTAL & CK_ENSURE) {
		RTHOOK(8);
...
void F1409_13399 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x, EIF_TYPED_VALUE arg3x, EIF_TYPED_VALUE arg4x, EIF_TYPED_VALUE arg5x)
{
	GTCX
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 1408, Current, 0, 5, 19873);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
void F1409_13400 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 1408, Current, 0, 2, 19874);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
void F1409_13401 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 1408, Current, 0, 2, 19875);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
void F1409_13403 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 1408, Current, 0, 2, 19876);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
void F1409_13404 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 1408, Current, 0, 2, 19877);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
static EIF_TYPED_VALUE F1409_13406_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1408, Current, 0, 0, 19878);
	RTSA(Dtype(Current));
	RTSC;
...
EIF_TYPED_VALUE F1409_13406 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9225, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1409_13406_body (Current)).it_r;
