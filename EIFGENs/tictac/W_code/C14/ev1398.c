...
extern void F1398_13160(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1398_13161(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1398_13162(EIF_REFERENCE);
extern void F1398_13163(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1398_13164(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1398_13165(EIF_REFERENCE, EIF_TYPED_VALUE);
static EIF_TYPED_VALUE F1398_13166_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1398_13166(EIF_REFERENCE);
extern void EIF_Minit1398(void);
extern EIF_REFERENCE _A1199_339();
extern EIF_REFERENCE _A1199_338();
...
void F1398_13160 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1397, Current, 0, 1, 19680);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1397, Current, 19680);
	RTCC(arg1, 1397, l_feature_name, 1, RTWCT(9225, dtype, Dftype(Current)), 0x01);
	RTIV(Current, RTAL);
...
void F1398_13161 (EIF_REFERENCE Current)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 1397, Current, 1, 0, 19681);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1397, Current, 19681);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	up1 = tp1;
	tp1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(5332, 967))(Current, up1x)).it_p);
	up1 = tp1;
	...
	
	{
		...
		typres0 = (typcache0.id != INVALID_DTYPE ? typcache0 : (typcache0 = eif_compound_id(dftype, typarr0)));
		tr3 = RTLNRW(typres0.id, 0, (EIF_POINTER) _A1199_338, (EIF_POINTER)(0),8082, 0, 0, 1, -1, tr2, 0);
	}
	ur2 = RTCCL(tr3);
	ur3 = NULL;
	...
	tp1 = *(EIF_POINTER *)(Current + RTWA(9742, dtype));
	up1 = tp1;
	tp1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(10066, dtype))(Current, up1x)).it_p);
	up1 = tp1;
	tr1 = RTMS_EX_H("clicked",7,169941860);
	ur1 = tr1;
	{
	...
	
	{
		...
		typres0 = (typcache0.id != INVALID_DTYPE ? typcache0 : (typcache0 = eif_compound_id(dftype, typarr0)));
		tr3 = RTLNRW(typres0.id, 0, (EIF_POINTER) _A1199_339, (EIF_POINTER)(0),8083, 0, 0, 1, -1, tr2, 0);
	}
	ur2 = RTCCL(tr3);
	ur3 = NULL;
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTWF(9747, dtype))(Current, up1x, ur1x, ur2x, ur3x);
...
EIF_TYPED_VALUE F1398_13162 (EIF_REFERENCE Current)
{
	GTCX
...
#define uw1 uw1x.it_c4
	...
	RTEAA(l_feature_name, 1397, Current, 9, 0, 19682);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1397, Current, 19682);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	tp1 = *(EIF_POINTER *)(Current + RTWA(9742, dtype));
	up1 = tp1;
	loc3 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(5331, 967))(Current, up1x)).it_p);
	RTHOOK(5);
	...
	RTNHOOK(7,1);
	tr2 = ((up2x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(8105, "font_names_on_system", tr1))(tr1)), (((up2x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up2x.it_r = RTBU(up2x))), (up2x.type = SK_POINTER), up2x.it_r);
	...
	for (;;) {
		...
		RTHOOK(11);
		tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(4616, "as_lower", loc9))(loc9)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
		ur1 = RTCCL(tr1);
		ui4_1 = ((EIF_INTEGER_32) 1L);
		ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTVF(4605, "substring_index", loc4))(loc4, ur1x, ui4_1x)).it_i4);
		if ((EIF_BOOLEAN)(ti4_1 == ((EIF_INTEGER_32) 1L))) {
			...
			if (!(EIF_BOOLEAN)(loc8 == NULL)) {
				...
				ti4_2 = *(EIF_INTEGER_32 *)(loc8 + RTVA(4824, "count", loc8));
			...
			ti4_2 = *(EIF_INTEGER_32 *)(loc4 + RTVA(4824, "count", loc4));
	...
	ur1 = RTCCL(tr1);
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(9425, "set_face_name", loc1))(loc1, ur1x);
	RTHOOK(18);
	tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(9402, "preferred_families", loc1))(loc1)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	RTNHOOK(18,1);
	...
	RTHOOK(19);
	RTDBGAL(Current, 7, 0xF800011C, 0, 0); /* loc7 */
	tw1 = (EIF_CHARACTER_32) (EIF_CHARACTER_8) ' ';
	uw1 = tw1;
	tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(4633, "split", loc4))(loc4, uw1x)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	loc7 = (EIF_REFERENCE) RTCCL(tr1);
	RTHOOK(20);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTVF(1703, "compare_objects", loc7))(loc7);
	RTHOOK(21);
	tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(2669, "last", loc7))(loc7)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	RTNHOOK(21,1);
	ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(4620, "to_integer", tr1))(tr1)).it_i4);
	ui4_1 = ti4_1;
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(9408, "set_height_in_points", loc1))(loc1, ui4_1x);
	RTHOOK(22);
	tb2 = '\01';
	...
	if (tb2) {
		...
		ui4_1 = ti4_1;
		(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(9406, "set_shape", loc1))(loc1, ui4_1x);
	} else {
		RTHOOK(24);
	...
	if (tb2) {
		...
		ui4_1 = ti4_1;
		(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(9405, "set_weight", loc1))(loc1, ui4_1x);
	} else {
		RTHOOK(27);
...
void F1398_13163 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1397, Current, 4, 1, 19683);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1397, Current, 19683);
	RTCC(arg1, 1397, l_feature_name, 1, eif_new_type(1236, 0x01), 0x01);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
body:;
	...
	tp1 = *(EIF_POINTER *)(loc2 + RTVA(9439, "font_description", loc2));
	up1 = tp1;
	loc4 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(5992, 968))(Current, up1x)).it_p);
	RTHOOK(5);
	...
	if ((EIF_BOOLEAN)(loc4 != tp1)) {
		...
		RTDBGAL(Current, 3, 0xF80004A9, 0, 0); /* loc3 */
		tr1 = RTLN(eif_new_type(1193, 0x00).id);
		tr2 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(9449, "name", loc2))(loc2)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
		tr3 = RTMS_EX_H(" ",1,32);
		ur1 = tr3;
		...
		ti4_1 = *(EIF_INTEGER_32 *)(loc2 + RTVA(9450, "height_in_points", loc2));
		RTNHOOK(7,1);
		tr2 = c_outi(ti4_1);
		ur1 = RTCCL(tr2);
	...
	up2 = tp2;
	loc1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTWF(5333, 967))(Current, up1x, up2x)).it_b);
	if (RTAL & CK_CHECK) {
		RTHOOK(9);
...
EIF_TYPED_VALUE F1398_13164 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_p
	...
	RTEAA(l_feature_name, 1397, Current, 0, 1, 19684);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 1);
	RTDBGEAA(1397, Current, 19684);
...
EIF_TYPED_VALUE F1398_13165 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_p
	...
	RTEAA(l_feature_name, 1397, Current, 0, 1, 19685);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 1);
	RTDBGEAA(1397, Current, 19685);
...
static EIF_TYPED_VALUE F1398_13166_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1397, Current, 0, 0, 19686);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1397, Current, 19686);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1398_13166 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9225, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1398_13166_body (Current)).it_r;
