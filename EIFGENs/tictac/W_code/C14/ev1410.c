...
extern void F1410_13407(EIF_REFERENCE);
extern void F1410_13408(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern void F1410_13409(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1410_13410(EIF_REFERENCE);
static EIF_TYPED_VALUE F1410_13411_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1410_13411(EIF_REFERENCE);
...
void F1410_13407 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui1_1 ui1_1x.it_i1
	...
	RTEAA(l_feature_name, 1409, Current, 0, 0, 19879);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1409, Current, 19879);
	RTIV(Current, RTAL);
	RTHOOK(1);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWF(9220, 1405))(Current);
	RTHOOK(2);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWF(9220, 1574))(Current);
	if (RTAL & CK_ENSURE) {
		RTHOOK(3);
...
void F1410_13408 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1409, Current, 1, 2, 19880);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1409, Current, 19880);
	RTCC(arg1, 1409, l_feature_name, 1, RTWCT(10185, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
...
void F1410_13409 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1409, Current, 2, 1, 19881);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1409, Current, 19881);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("i_within_bounds", EX_PRE);
...
body:;
	...
	RTNHOOK(3,1);
	tr3 = ((up2x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(8290, "implementation", tr2))(tr2)), (((up2x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up2x.it_r = RTBU(up2x))), (up2x.type = SK_POINTER), up2x.it_r);
	loc1 = RTCCL(tr3);
	loc1 = RTRV(eif_new_type(1403, 0x00), loc1);
	if (RTAL & CK_CHECK) {
		RTHOOK(4);
	...
	if ((EIF_BOOLEAN)(loc1 != NULL)) {
		...
		*(EIF_INTEGER_32 *)(Current + RTWA(9817, dtype)) = (EIF_INTEGER_32) loc2;
	}
	if (RTAL & CK_ENSURE) {
		RTHOOK(11);
...
EIF_TYPED_VALUE F1410_13410 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1409, Current, 0, 0, 19882);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1409, Current, 19882);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x40000000, 1,0); /* Result */
	Result = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(10208, Dtype(Current)))(Current)).it_p);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(2);
	RTDBGLE;
...
static EIF_TYPED_VALUE F1410_13411_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1409, Current, 0, 0, 19883);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1409, Current, 19883);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1410_13411 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9225, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1410_13411_body (Current)).it_r;
