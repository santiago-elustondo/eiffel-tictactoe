...
extern EIF_TYPED_VALUE F1386_13075(EIF_REFERENCE);
extern void F1386_13076(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1386_13078(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1386_13079(EIF_REFERENCE);
static EIF_TYPED_VALUE F1386_13080_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1386_13080(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1386_13075 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1385, Current, 1, 0, 19623);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1385, Current, 19623);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F1386_13076 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1385, Current, 2, 1, 19624);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1385, Current, 19624);
	RTCC(arg1, 1385, l_feature_name, 1, eif_new_type(1236, 0x01), 0x01);
	RTIV(Current, RTAL);
...
body:;
	...
	if (!RTCEQ(tr1, arg1)) {
		...
		RTHOOK(4);
		RTDBGAA(Current, dtype, 10011, 0xF80004D4, 0); /* private_font */
		RTAR(Current, loc2);
		*(EIF_REFERENCE *)(Current + RTWA(10011, dtype)) = (EIF_REFERENCE) RTCCL(loc2);
		RTHOOK(5);
		...
		RTHOOK(7);
		tb1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(9424, "font_is_default", loc1))(loc1)).it_b);
		if (tb1) {
			RTHOOK(8);
			...
			up2 = tp2;
			(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTWF(6087, 968))(Current, up1x, up2x);
		} else {
			RTHOOK(9);
			tp1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(10010, dtype))(Current)).it_p);
			up1 = tp1;
			tp2 = *(EIF_POINTER *)(loc1 + RTVA(9439, "font_description", loc1));
			up2 = tp2;
			(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTWF(6087, 968))(Current, up1x, up2x);
		}
	}
...
EIF_TYPED_VALUE F1386_13078 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1385, Current, 0, 0, 19625);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1385, Current, 19625);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F1386_13079 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	r.it_r = *(EIF_REFERENCE *)(Current + RTWA(10011,Dtype(Current)));
	return r;
}


/* {EV_FONTABLE_IMP}.interface */
static EIF_TYPED_VALUE F1386_13080_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1385, Current, 0, 0, 19627);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
...
EIF_TYPED_VALUE F1386_13080 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9225, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1386_13080_body (Current)).it_r;
