...
extern void F1417_13482(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1417_13483(EIF_REFERENCE);
static EIF_TYPED_VALUE F1417_13484_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1417_13484(EIF_REFERENCE);
...
void F1417_13482 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1416, Current, 0, 1, 19943);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1416, Current, 19943);
	RTCC(arg1, 1416, l_feature_name, 1, RTWCT(9225, dtype, Dftype(Current)), 0x01);
	RTIV(Current, RTAL);
...
void F1417_13483 (EIF_REFERENCE Current)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 1416, Current, 0, 0, 19944);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
static EIF_TYPED_VALUE F1417_13484_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1416, Current, 0, 0, 19945);
	RTSA(Dtype(Current));
	RTSC;
...
EIF_TYPED_VALUE F1417_13484 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9225, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1417_13484_body (Current)).it_r;
