...
extern void F1171_10210(EIF_REFERENCE);
...
/* {ETF_PLAY_AGAIN}.play_again */
void F1171_10210 (EIF_REFERENCE Current)
{
	GTCX
	char *l_feature_name = "play_again";
	RTEX;
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1170, Current, 0, 0, 16850);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1170, Current, 16850);
	RTIV(Current, RTAL);
	RTHOOK(1);
