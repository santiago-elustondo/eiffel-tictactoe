...
extern EIF_TYPED_VALUE F1273_11433(EIF_REFERENCE);
extern void F1273_11434(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1273_11433 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1273_11434 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1272, Current, 0, 0, 18195);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1272, Current, 18195);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 8290, 0xF8000585, 0); /* implementation */
