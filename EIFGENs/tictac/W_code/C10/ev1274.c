...
extern EIF_TYPED_VALUE F1274_11435(EIF_REFERENCE);
extern void F1274_11436(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1274_11435 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1274_11436 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1273, Current, 0, 0, 18197);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 8290, 0xF8000586, 0); /* implementation */
