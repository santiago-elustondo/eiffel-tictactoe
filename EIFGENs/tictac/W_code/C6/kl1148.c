...
extern EIF_TYPED_VALUE F1148_10042(EIF_REFERENCE);
...
RTOID (F1148_10042)
EIF_TYPED_VALUE F1148_10042 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1147, Current, 0, 0, 16689);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1147, Current, 16689);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
