...
extern void F1147_10039(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1147_10040(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1147_10041(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void EIF_Minit1147(void);
extern EIF_REFERENCE _A1147_182();
...
void F1147_10039 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1146, Current, 0, 1, 16686);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1146, Current, 16686);
	{
...
void F1147_10040 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1146, Current, 0, 1, 16687);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1146, Current, 16687);
	{
		static EIF_TYPE_INDEX typarr0[] = {0xFF01,251,0xFF01,0xFFF9,0,185,0xFFFF};
		EIF_TYPE typres0;
		static EIF_TYPE typcache0 = {INVALID_DTYPE, 0};
	...
	
	{
		...
		typres0 = (typcache0.id != INVALID_DTYPE ? typcache0 : (typcache0 = eif_compound_id(dftype, typarr0)));
		tr2 = RTLNRW(typres0.id, 0, (EIF_POINTER) _A1147_182, (EIF_POINTER)(0),7668, 0, 0, 1, -1, tr1, 0);
	}
	ur1 = RTCCL(tr2);
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1146, Current, 0, 1, 16688);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1146, Current, 16688);
	RTIV(Current, RTAL);
